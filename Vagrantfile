...
Vagrant.configure("2") do |config|
  config.vm.define "centos-6.5" do |centos6|
    ...
    centos6.vm.box_url = "http://opscode-vm-bento.s3.amazonaws.com/vagrant/virtualbox/opscode_centos-6.5_chef-provisionerless.boxx"
    centos6.omnibus.chef_version = :latest
    centos6.vm.network :private_network, ip: "192.168.254.10"
  end

  config.vm.define "centos-7.0" do |centos7|
    centos7.vm.box = "centos7"
    centos7.vm.box_url = "http://opscode-vm-bento.s3.amazonaws.com/vagrant/virtualbox/opscode_centos-7.0_chef-provisionerless.boxx"
    centos7.omnibus.chef_version = :latest
    centos7.vm.network :private_network, ip: "192.168.254.11"
  end
  ...
  config.vm.define "ubuntu-12.04" do |ubuntu12|
    ...
    ubuntu12.vm.network :private_network, ip: "192.168.254.12"
  end
  ...
  config.vm.define "ubuntu-14.04" do |ubuntu14|
    ...
    ubuntu14.vm.network :private_network, ip: "192.168.254.13"
  end
